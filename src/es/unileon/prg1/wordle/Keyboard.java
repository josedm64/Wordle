...
//Clase para la gestión de entrada por teclado
//Modificado 09/2004
/*
...
/**
*  Clase que permite leer valores simples de la línea de comandos.
*  Si ocurre un error durante la lectura las excepciones lanzadas
*  son capturadas y se retorna el menor valor representable
*  del tipo de datos leído.
*
*  Nota: esta no es una muy buena opción de tratar los posibles errores. En futuras versiones
*  (cuando se explique la gestión de excepciones) se mejorará este tratamiento.
*
*  @version 1.0
*  @author PRG
*/
...
/**
* Stream para leer líneas de la entrada standard (por defecto el teclado)
*
* @see BufferedReader
...
/**
* Atributo para almacenar la línea leída por teclado
*
* @see String
*/
...
*
*
*  @return Retorna el valor introducido por el teclado. Si se introduce un valor que no es correcto se retorna el mínimo
...
private static void error(String msg) {
 ...
 System.err.println("Imposible continuar la ejecución del programa") ;
 System.exit(0) ;
}
}